...
// AjaxObject.prototype.getall = function () {
//   tableData = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0"},{"s_sn":"50","cnname":"趙雪瑜","enname":"Sharon","sex":"0"},{"s_sn":"51","cnname":"賴佳蓉","enname":"Yoki","sex":"1"}]';
//   refreshTable(JSON.parse(tableData));
// }
// AjaxObject.prototype.add = function () {

//   tableData.push({"s_sn":"52","cnname":"新增帳號","enname":"NewAccount","sex":"1"});
...
// }
// AjaxObject.prototype.modify = function () {
//   tableData = '[{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0"}]';
//   refreshTable(JSON.parse(tableData));
//   $("#dialog-modifyconfirm").dialog("close");
// }
// AjaxObject.prototype.modify_get = function () {
//   tableData = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0"},{"s_sn":"50","cnname":"趙雪瑜","enname":"Sharon","sex":"0"},{"s_sn":"51","cnname":"賴佳蓉","enname":"Yoki","sex":"1"}]';
//   initEdit(JSON.parse(tableData));
// }
// AjaxObject.prototype.search = function () {
//   tableData = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0"}]';
//   refreshTable(JSON.parse(tableData));
//   $("#dialog-searchconfirm").dialog("close");
// }
// AjaxObject.prototype.delete = function () {
//   tableData = '[{"s_sn":"35","cnname":"邱小甘","enname":"Peter","sex":"0"},{"s_sn":"49","cnname":"蔡凡昕","enname":"Allen","sex":"0"}]';
//   refreshTable(JSON.parse(tableData));
// }
